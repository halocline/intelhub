...
class RoadmapsControllerTest < ActionController::TestCase
  ...
  test "should create roadmap" do
    assert_difference('Roadmap.count') do
      post :create, roadmap: { problem_id: @roadmap.problem_id, required_resources: @roadmap.required_resources }
    end
  ...
  test "should update roadmap" do
    patch :update, id: @roadmap, roadmap: { problem_id: @roadmap.problem_id, required_resources: @roadmap.required_resources }
    assert_redirected_to roadmap_path(assigns(:roadmap))
  end
