...
class DataItemsControllerTest < ActionController::TestCase
  ...
  test "should create data_item" do
    assert_difference('DataItem.count') do
      post :create, data_item: { data_class_id: @data_item.data_class_id, data_source_id: @data_item.data_source_id, name: @data_item.name }
    end
  ...
  test "should update data_item" do
    patch :update, id: @data_item, data_item: { data_class_id: @data_item.data_class_id, data_source_id: @data_item.data_source_id, name: @data_item.name }
    assert_redirected_to data_item_path(assigns(:data_item))
  end
