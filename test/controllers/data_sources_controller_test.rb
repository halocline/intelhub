...
class DataSourcesControllerTest < ActionController::TestCase
  ...
  test "should create data_source" do
    assert_difference('DataSource.count') do
      post :create, data_source: { description: @data_source.description, name: @data_source.name, uri: @data_source.uri }
    end
  ...
  test "should update data_source" do
    patch :update, id: @data_source, data_source: { description: @data_source.description, name: @data_source.name, uri: @data_source.uri }
    assert_redirected_to data_source_path(assigns(:data_source))
  end
